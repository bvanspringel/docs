...
Here is an example of a complete `devices.json` file, featuring devices with various protocols and types. Please note that this file is for illustration only and 
