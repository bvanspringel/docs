...
to communicate and interact with the device. The final JSON file should be saved with a unique name and a `.json` extension. For example, `cet_30C3_address_map.json`.

### Example

```json modbus_address_map.json icon="code"
[
  {
    "address": 0,
    "numberOfRegisters": 1,
