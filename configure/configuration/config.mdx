...
- **localUsername:** The username for setting up a local NATS server on the PPL controller. (Type: String)
- **localPassword:** The password for setting up a local NATS server on the PPL controller. (Type: String)
...
- **cloudUsername:** The username for connecting to the cloud NATS server, used to store controller data in the cloud database. (Type: String)
- **cloudPassword:** The password for connecting to the cloud NATS server, used to store controller data in the cloud database. (Type: String)
